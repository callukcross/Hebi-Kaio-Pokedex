...
public sealed class EncounterGeneratorForm : Form
{
    ...
    public EncounterGeneratorForm(ProfileService profiles, IPokemonCatalog catalog, ReferenceRulesCatalog rules)
    {
        ...
        filters.Controls.AddRange([Label("Pokémon level"), _level, Label("Minimum species rating"), _minimumSr, Label("Maximum species rating"), _maximumSr, Label("Generation"), _generation, Label("Type"), _type]);
    ...
    private void Reset() { _level.Value = 1; _minimumSr.Value = 0; _maximumSr.Value = 30; _generation.SelectedIndex = 0; _type.SelectedIndex = 0; Randomize(); }
